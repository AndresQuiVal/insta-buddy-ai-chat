...
serve(async (req) => {
  ...
  try {
    ...
    const userResponse = await fetch(
      `https://graph.instagram.com/me?fields=user_id,username,account_type,instagram_business_account&access_token=${finalAccessToken}`,
    );
    ...
    const finalInstagramUserId = userData.user_id; // Este es el ID correcto de Instagram Business
