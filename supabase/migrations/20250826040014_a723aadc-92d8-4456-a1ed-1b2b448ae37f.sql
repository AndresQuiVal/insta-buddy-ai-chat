...
AS $function$
BEGIN
  -- Contar prospectos basándose en la misma lógica que la interfaz
  RETURN QUERY
  WITH prospect_counts AS (
    SELECT 
      -- URGENTES: prospectos que han respondido y NO hay timestamp de último mensaje del dueño O menos de 24h, y NO tachados
      ...
      -- SEGUIMIENTOS: prospectos contactados hace más de 24 horas y NO tachados
