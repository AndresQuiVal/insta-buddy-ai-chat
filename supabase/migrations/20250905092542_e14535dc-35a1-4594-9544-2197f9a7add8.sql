-- Fix the username filtering issue in grok_get_stats_with_usernames_filter
-- The issue is that usernames might not match exactly, we need to be more flexible
