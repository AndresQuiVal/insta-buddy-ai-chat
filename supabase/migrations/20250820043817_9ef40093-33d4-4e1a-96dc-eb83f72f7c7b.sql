-- Corregir la función sync_prospect_task_status para usar el task_type dinámico
CREATE OR REPLACE FUNCTION public.sync_prospect_task_status(
  ...
  p_task_type text DEFAULT 'pending'
)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  INSERT INTO public.prospect_task_status (
    ...
    p_task_type,  -- Usar el parámetro dinámico en lugar de 'pending' hardcodeado
