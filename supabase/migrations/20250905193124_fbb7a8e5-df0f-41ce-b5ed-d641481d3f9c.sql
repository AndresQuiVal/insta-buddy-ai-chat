-- Actualizar función grok_get_stats para retornar "respuestas" en lugar de "abiertas"
-- y corregir la lógica para contar respuestas únicas por período
...
-- Actualizar función grok_get_stats_with_usernames_filter
