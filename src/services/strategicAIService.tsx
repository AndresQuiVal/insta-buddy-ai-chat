...
// Función para obtener la personalidad guardada
const getSavedPersonality = (): string | null => {
  return localStorage.getItem('hower-system-prompt');
};
...
export const createStrategicPrompt = (
  ...
  const savedPersonality = getSavedPersonality();
